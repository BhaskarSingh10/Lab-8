...
<nav>
	<ul>
		...
		<!-- STEP 10: Add a new link to the new green.php page inside the above list of links -->
		<li><a href="/newgreen.php" title="Learn about the new green blocks">New Green Blocks</a></li>
	</ul>
</nav>
